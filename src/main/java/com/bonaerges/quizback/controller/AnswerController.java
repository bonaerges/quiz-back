...
public class AnswerController {
	...
	public ResponseEntity<AnswerDTO> findById(@PathVariable("id") Integer id) {
	...
	public List<AnswerDTO> findAll(@RequestParam(value = "page", defaultValue = "0", required = false) Integer page,
