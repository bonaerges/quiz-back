...
public class UserController {
	...
	public List<UserDTO> findAll(@RequestParam(value = "page", defaultValue = "0", required = false) Integer page,
			@RequestParam(value = "size", defaultValue = "10", required = false) Integer size) {

		List<User> users = (List<User>) userService.findAll(PageRequest.of(page, size)).stream()
	...
	// respEnt=new
	// ResponseEntity<UserDTO>(userMapper.modelToDto(user.get()),HttpStatus.OK);
	// }
